...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:321px;top:175px;"
    ...
    <div component="$UI/system/components/justep/data/baasData" autoLoad="false"
      ...
      <column label="picture" name="picture" type="String" xid="default5"/>  
      <column label="number" name="number" type="Integer" xid="default6"/>  
      <column label="consignee" name="consignee" type="String" xid="default7"/>  
      <column label="telephone" name="telephone" type="String" xid="default8"/>  
      <column label="area" name="area" type="String" xid="default9"/>  
      <column label="address" name="address" type="String" xid="default10"/>  
      <column label="remarks" name="remarks" type="String" xid="default11"/>  
      <column label="medprice" name="medprice" type="Float" xid="default12"/>  
      <column label="transportprice" name="transportprice" type="Float" xid="default13"/>  
      <column label="dealnumber" name="dealnumber" type="String" xid="default14"/>  
      <column label="logisticstelephone" name="logisticstelephone" type="String"
        xid="default15"/>  
      <column label="logistics" name="logistics" type="String" xid="default16"/>  
      <column label="logisticsnumber" name="logisticsnumber" type="String" xid="default17"/>  
      <column label="dealtime" name="dealtime" type="DateTime" xid="default18"/>  
      <column label="ordertime" name="ordertime" type="DateTime" xid="default19"/>  
      <column label="managetime" name="managetime" type="DateTime" xid="default20"/> 
    </div> 
  </div>  
  <div class="head"> 
  ...
  <div class="menu"> 
    ...
    <div class="submenu"> 
      ...
      <div class="submenudiv" id="wcl" bind-click="jumc"> 
        <i xid="i19" class="icon-arrow-right-b"/>  
        <span>已完成订单</span> 
      </div> 
    </div>  
  ...
  <div class="title"> 
    ...
    <div class="loca"> 
      ...
      <span class="black"> 
        <img src="../medicine/image/xg.jpg"/>已完成订单
      </span> 
    </div> 
  </div>  
  <div class="main"> 
    <div class="table"> 
      <div class="tabletitlediv"> 
        <div class="tabletitle number">处理时间</div>  
        <div class="tabletitle consignee">收货人</div>  
        <div class="tabletitle telephone">联系电话</div>  
        <div class="tabletitle area">物流公司</div>  
        <div class="tabletitle address">物流单号</div>  
        <div class="tabletitle details">总金额</div> 
      </div>  
        ...
        <ul class="x-list-template" xid="listTemplateUl1"> 
          <li xid="li5"> 
            <div component="$UI/system/components/justep/row/row" class="x-row"
              xid="row1"> 
              <div class="x-col x-col-fixed" style="width:16%" xid="col1"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" xid="output2" bind-ref="ref('managetime')"/> 
              </div>  
              <div class="x-col x-col-fixed" style="width:16%" xid="col2"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" xid="output3" bind-ref="ref('consignee')"/> 
              </div>  
              <div class="x-col x-col-fixed" style="width:16%" xid="col3"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" xid="output4" bind-ref="ref('telephone')"/> 
              </div>  
              <div class="x-col x-col-fixed" style="width:16%" xid="col4"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" xid="output5" bind-ref="ref('logistics')"/> 
              </div>  
              <div class="x-col x-col-fixed" style="width:16%" xid="col5"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" xid="output6" bind-ref="ref('logisticsnumber')"/> 
              </div>  
              <div class="x-col x-col-fixed" style="width:16%" xid="col6"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" id="output6" onRender="output1Render"/> 
              </div> 
            </div> 
          </li> 
        </ul> 

  ...
  <div class="main"> 
    <div class="table"> 
      <div class="tabletitlediv"> 
        <div class="tabletitle number">付款时间</div>  
        ...
        <div class="tabletitle details">物流信息</div> 
      </div>  
            ...
            <div component="$UI/system/components/justep/row/row" class="x-row"
              ...
              <div class="x-col x-col-fixed" style="width:15%" xid="col1"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" xid="output2" bind-ref="ref('dealtime')"/> 
              </div>  
              ...
              <div class="x-col x-col-fixed" style="width:35%" xid="col5"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" xid="output6" bind-ref="ref('address')"/> 
              </div>  
              <div class="x-col x-col-fixed" style="width:10%" xid="col6"> 
                <i class="icon-edit" bind-click="i9Click"/> 
              </div> 
            </div> 
          </li> 
        </ul> 

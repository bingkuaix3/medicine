...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:321px;top:175px;"
    ...
    <div component="$UI/system/components/justep/data/baasData" autoLoad="false"
      ...
      url="/medicine/med_action" idColumn="id" confirmDelete="false" confirmRefresh="false"> 
      ...
      <column label="logistics" name="logistics" type="String" xid="default15"/>  
      <column label="logisticsnumber" name="logisticsnumber" type="String" xid="default16"/>  
      <column label="dealtime" name="dealtime" type="DateTime" xid="default17"/>  
      <column label="ordertime" name="ordertime" type="DateTime" xid="default18"/> 
    </div> 
  </div>  
  <div class="head"> 
  ...
  <div class="menu"> 
    ...
    <div class="submenu"> 
      ...
      <div class="submenudiv" id="wcl" bind-click="jumd"> 
        <i xid="i19" class="icon-arrow-right-b"/>  
        <span>已处理订单</span> 
      </div>  
  ...
  <div class="title"> 
    ...
    <div class="loca"> 
      ...
      <span class="black"> 
        <img src="../medicine/image/xg.jpg"/>已处理订单
      </span> 
    </div> 
  </div>  
  <div class="main"> 
    <div class="table"> 
      <div class="tabletitlediv"> 
        <div class="tabletitle number">下单时间</div>  
        ...
        <div class="tabletitle details">放弃</div> 
      </div>  
        ...
        <ul class="x-list-template" xid="listTemplateUl1"> 
          <li xid="li5"> 
            <div component="$UI/system/components/justep/row/row" class="x-row"
              xid="row1"> 
              <div class="x-col x-col-fixed" style="width:15%" xid="col1"> 
                <div component="$UI/system/components/justep/output/output"
                  class="x-output" xid="output2" bind-ref="ref('ordertime')"/> 
              </div>  
              <div class="x-col x-col-fixed" style="width:10%" xid="col2"> 
                <div component="$UI/system/components/justep/output/output"
              ...
              <div class="x-col x-col-fixed" style="width:5%" xid="col6"> 
                <i class="icon-android-close" bind-click="del"/> 
              </div> 
            </div> 
          </li> 
        </ul> 
